...
글을 쓰면서 머리 속에 다시 한번 정리 되는 효과도 있고, 나만의 자료가 남는다는 장점도 있기에 자주는 못 쓰더라도 "꾸준히" 쓰는 것을 목표로 삼았습니다. (⊙ㅁ⊙)  

<br/>
이러한 이유로 저는 github pages를 이용한 블로그를 만들게 되었습니다.
많은 블로그 중에서도 github pages와 Jekyll의 조합에 흥미가 생겨서 직접 해보니 약간 골치아프지만.. 만들어가는 과정이 재미있기도 하네요!  
